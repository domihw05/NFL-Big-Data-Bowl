...
or not. That being said, according to the r^2 value, this relationship only
accounts for 1.4% of the variation in whether they blitz or not. Also,
by running the Hosmer and Lemeshow test, we found that the data are not
reasonably logistic, meaning the resulting data from the binary logistic
regression model is unreliable.

We need to explore further to see if the linear regression model is justified
