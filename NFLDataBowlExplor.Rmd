...
head(player_raw_data)
head(plays_raw_data)
sum <- summary(player_raw_data)
structure <- str(player_raw_data)
```
...
```{r}
lm.yardsByPlayClock <- lm(yardsGained ~ playClockAtSnap + timeToThrow,plays_raw_data)
