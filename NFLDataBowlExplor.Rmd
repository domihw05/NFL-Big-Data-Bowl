...
Here we upload our data from the NFL Data Bowl database. This includes data
about each NFL player, data about each play over the time period covered, and
tracking data over the first 9 weeks of the 2022 (I think) season.
...
#tracking8_raw <- read_csv("tracking_week_8.csv")
#tracking9_raw <- read_csv("tracking_week_9.csv")
>>>>>>> 4cbc4082539d7f429e1dd6e647f3876a8ce8d1b0
```
...
Y <- plays_raw_data$yardsGained
x <- plays_raw_data$pff_passCoverage
boxplot(Y ~ x,col="peachpuff")

anova(lm.yardsByPlayClock)
```
>>>>>>> 4cbc4082539d7f429e1dd6e647f3876a8ce8d1b0
