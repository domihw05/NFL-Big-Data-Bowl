...
and test the model's success on the test_data. \
...
- 1025 plays were correctly predicted as Complete Passes.\
- 173 plays were correctly predicted as Incomplete Passes.\ 
- 400 plays were misclassified as complete when they were actually incomplete.\
- 27 plays were misclassified as complete when they were actually interceptions.\
- 99 plays were misclassified as incomplete when they were actually complete.\
...
is almost 70% at approximately 69.05% accuracy. This is an improvement to the No 
...
says with 95% confidence that the true prediction accuracy is between 66.81% and 
and 71.22%. 
